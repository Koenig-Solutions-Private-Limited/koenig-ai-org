...
ticket: KOEA-13616
title: "How to Switch from IT Support to DevOps in 2026: A Support-First Roadmap"
description: "How to switch from IT support to DevOps in 2026: use support troubleshooting as your base, then add Linux, cloud, Terraform, Kubernetes, CI/CD, monitoring, and a staged certification path."
seo_description: "How to switch from IT support to DevOps in 2026: support-to-DevOps roadmap, BLS job outlook, cert ladder, project proof, salary caveats, and CV funnel."
slug: 2026-07-27-how-to-switch-from-it-support-to-devops
...
contrarian_angle: "The switch is not a personality reinvention from helpdesk to engineer; it is a labor-market hedge where a shrinking support occupation can grow into software-delivery operations with proof, not hype."
sources: ["https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm", "https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm", "https://www.onetonline.org/link/summary/15-1252.00", "https://www.indeed.com/career/devops-engineer/salaries", "https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/", "https://training.linuxfoundation.org/certified-kubernetes-administrator-cka-program-changes/", "https://developer.hashicorp.com/certifications/infrastructure-automation", "https://aws.amazon.com/certification/certified-solutions-architect-associate/", "https://aws.amazon.com/certification/certified-devops-engineer-professional/", "https://aws.amazon.com/blogs/training-and-certification/exam-update-and-new-name-for-operations-certification/", "https://learn.microsoft.com/en-us/credentials/certifications/devops-engineer/", "https://learn.microsoft.com/en-us/credentials/certifications/azure-administrator/", "https://training.linuxfoundation.org/certification/kubernetes-and-cloud-native-associate-kcna/", "https://www.cncf.io/announcements/2026/01/20/kubernetes-established-as-the-de-facto-operating-system-for-ai-as-production-use-hits-82-in-2025-cncf-annual-cloud-native-survey/", "https://dora.dev/dora-report-2025/", "https://sre.google/sre-book/being-on-call/", "https://roadmap.sh/devops"]
whats_new: ["In 2026, the support-to-DevOps switch is a decline-to-growth move: BLS projects computer support specialists down 3% while the closest DevOps-mapped software developer group grows 15%."]
learning_objectives: ["Map IT support skills to DevOps responsibilities without inventing a direct promotion path.", "Choose a staged certification ladder using current 2026 exam names and codes.", "Build a CV-ready proof project that shows troubleshooting, automation, cloud, containers, and monitoring."]
positions:
  - id: stance:harness-over-model
    engagement: refines
faq:
  - {question: "Can I switch from IT support to DevOps without a degree?", answer: "Yes, but the switch needs evidence. BLS says computer support entry requirements vary and some candidates qualify with certifications, while O*NET lists DevOps Engineer as a reported title under Software Developers, a role that usually needs considerable preparation. Build a project, automate repeatable work, and use a current cert ladder. Sources retrieved 2026-07-27: https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm and https://www.onetonline.org/link/summary/15-1252.00."}
  - {question: "Which certification should IT support people take first for DevOps?", answer: "Pick the first cert by target cloud. For Azure-heavy support teams, AZ-104 is the practical first step and was updated April 17, 2026. For AWS, Solutions Architect Associate or CloudOps Engineer Associate can fit. Do not use old SysOps SOA-C02 advice because AWS renamed the operations path to CloudOps Engineer SOA-C03. Sources retrieved 2026-07-27: https://learn.microsoft.com/en-us/credentials/certifications/azure-administrator/ and https://aws.amazon.com/blogs/training-and-certification/exam-update-and-new-name-for-operations-certification/."}
  - {question: "How long does it take to move from support to DevOps?", answer: "A realistic plan is usually measured in months, not weeks, because DevOps requires cloud, automation, source control, infrastructure as code, containers, monitoring, and delivery workflow proof. The exact time depends on your current Linux, networking, scripting, and cloud exposure. Use a staged portfolio checklist instead of a fixed promise. Sources retrieved 2026-07-27: https://roadmap.sh/devops and https://sre.google/sre-book/being-on-call/."}
  - {question: "Is DevOps still a good career path in 2026?", answer: "DevOps is still a strong adjacent path if you frame the data carefully. BLS does not track a separate DevOps occupation, but O*NET lists DevOps Engineer under Software Developers. BLS projects the broader software developers, QA analysts, and testers group to grow 15% from 2024 to 2034, while computer support specialists decline 3%. Sources retrieved 2026-07-27: https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm and https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm."}
original_data: false
last_updated: 2026-07-27
hero_image: {url: /img/blogs/how-to-switch-from-it-support-to-devops/hero.png, alt: "IT support workstation transitioning into DevOps cloud operations with terminals pipelines Kubernetes diagrams monitoring dashboards and incident notes"}
---
...
The contrarian point: this is not a reinvention from "support person" to "real engineer." It is a decline-to-growth move. BLS projects computer support specialists to decline 3% from 2024 to 2034, while the broader software developers, QA analysts, and testers group grows 15% in the same cycle ([BLS support](https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm) and [BLS software developers](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm), retrieved 2026-07-27). BLS does not publish a DevOps occupation, so use the closest mapping honestly: O*NET lists "DevOps Engineer" as a reported title under Software Developers 15-1252.00 ([O*NET, retrieved 2026-07-27](https://www.onetonline.org/link/summary/15-1252.00)).

![IT support workstation transitioning into DevOps cloud operations with terminals pipelines Kubernetes diagrams monitoring dashboards and incident notes](/img/blogs/how-to-switch-from-it-support-to-devops/hero.png)
...
BLS describes computer support specialists as people who maintain networks, provide technical help, diagnose user problems, document descriptions, guide troubleshooting steps, and alert teams to major or recurring problems ([BLS, retrieved 2026-07-27](https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm)). That is not distant from operations. Google SRE's on-call chapter treats incident response as a disciplined engineering workflow with escalation, paging expectations, and limits on incident load, not as heroic improvisation ([Google SRE Book, retrieved 2026-07-27](https://sre.google/sre-book/being-on-call/)).
...
hours_per_week = 10
plan = {
    "Linux, networking, and Git": 0.20,
    "Bash or Python automation": 0.15,
    "AWS or Azure operations": 0.20,
    "Terraform infrastructure as code": 0.15,
    "Containers and Kubernetes": 0.15,
    "Monitoring, CI/CD, and runbooks": 0.15,
}

for topic, share in plan.items():
    print(f"{topic}: {hours_per_week * share:.1f} hours/week")
```
...
The right certification path depends on your target ecosystem. For Azure support backgrounds, start with Azure Administrator Associate. Microsoft lists AZ-104 as an intermediate operations credential covering identities, governance, storage, compute, virtual networking, and monitoring; its exam content was updated April 17, 2026 ([Microsoft AZ-104, retrieved 2026-07-27](https://learn.microsoft.com/en-us/credentials/certifications/azure-administrator/)). AZ-400 is the destination Azure DevOps credential, but Microsoft requires Azure Administrator Associate or Azure Developer Associate first and flagged an English-version update on June 27, 2026 ([Microsoft AZ-400, retrieved 2026-07-27](https://learn.microsoft.com/en-us/credentials/certifications/devops-engineer/)).

For AWS, do not follow stale "SysOps Administrator SOA-C02" advice. AWS renamed the operations associate route to AWS Certified CloudOps Engineer - Associate SOA-C03; SOA-C02's last day was September 29, 2025, and AWS says SOA-C03 adds containers, automation, multi-account and multi-Region architecture, and infrastructure as code ([AWS Training and Certification Blog, retrieved 2026-07-27](https://aws.amazon.com/blogs/training-and-certification/exam-update-and-new-name-for-operations-certification/)). Solutions Architect Associate SAA-C03 remains a useful architecture base, while DevOps Engineer Professional DOP-C02 is better after real AWS operations exposure ([AWS SAA](https://aws.amazon.com/certification/certified-solutions-architect-associate/) and [AWS DOP-C02](https://aws.amazon.com/certification/certified-devops-engineer-professional/), retrieved 2026-07-27).

For platform skills, use current versions. HashiCorp's Terraform Associate is version 004, not 003, and the current page lists a one-hour online-proctored exam tested on Terraform 1.12 ([HashiCorp, retrieved 2026-07-27](https://developer.hashicorp.com/certifications/infrastructure-automation)). For Kubernetes, KCNA is the beginner credential, while CKA is performance-based, two hours, $445 exam-only, and based on Kubernetes v1.35 as of July 2026 ([KCNA](https://training.linuxfoundation.org/certification/kubernetes-and-cloud-native-associate-kcna/) and [CKA](https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/), retrieved 2026-07-27). The CKA February 2025 program update added Gateway API, Helm, Kustomize, CRDs, and operators, so old CKA roadmaps can be stale ([Linux Foundation, retrieved 2026-07-27](https://training.linuxfoundation.org/certified-kubernetes-administrator-cka-program-changes/)).
...
Yes, but the switch needs evidence. BLS says computer support entry requirements vary and some candidates qualify with certifications, while O*NET places DevOps Engineer under Software Developers, a role requiring considerable preparation. Build a project, automate support-style tasks, and use current certifications as structure rather than as a substitute for proof ([BLS](https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm) and [O*NET](https://www.onetonline.org/link/summary/15-1252.00), retrieved 2026-07-27).

### Which certification should IT support people take first for DevOps?

Choose by target cloud. Azure-heavy support workers should usually start with AZ-104 because it maps to administrator operations and now reflects the April 17, 2026 content update. AWS learners can use SAA-C03 or CloudOps Engineer SOA-C03. Add Terraform Associate 004 after basic cloud comfort, then KCNA or CKA when containers become your target ([Microsoft AZ-104](https://learn.microsoft.com/en-us/credentials/certifications/azure-administrator/), [AWS CloudOps rename](https://aws.amazon.com/blogs/training-and-certification/exam-update-and-new-name-for-operations-certification/), and [HashiCorp](https://developer.hashicorp.com/certifications/infrastructure-automation), retrieved 2026-07-27).

### How long does it take to move from support to DevOps?

Plan in stages, not promises. If you already know Linux, networking, and one cloud, you may build credible proof faster. If you are starting from password resets and desktop support, expect a longer path through scripting, Git, cloud operations, Terraform, containers, and monitoring. Google SRE's on-call guidance is a reminder that operations work requires sustainable process, not shortcuts ([Google SRE Book, retrieved 2026-07-27](https://sre.google/sre-book/being-on-call/)).

### Is DevOps still a good career path in 2026?

Yes, if you label the data honestly. BLS does not track "DevOps engineer" as a separate occupation, but O*NET lists DevOps Engineer as a reported title under Software Developers. BLS projects the broader software developers, QA analysts, and testers group to grow 15% from 2024 to 2034, while computer support specialists decline 3% ([O*NET](https://www.onetonline.org/link/summary/15-1252.00), [BLS software developers](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm), and [BLS support](https://www.bls.gov/ooh/computer-and-information-technology/computer-support-specialists.htm), retrieved 2026-07-27).
