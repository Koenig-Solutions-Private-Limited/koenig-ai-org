...
reading_time_min: 8
slug: cloudflare-workers-ai-agents-durable-objects-tutorial-2026
...
hero_image:
  url: /img/blogs/cloudflare-workers-ai-agents-durable-objects-tutorial-2026/hero.png
...
![Architecture diagram of a Cloudflare Workers AI agent using a Durable Object for state, Workers AI for inference, and bindings for D1, R2, KV, Queues, and AI Gateway](/img/blogs/cloudflare-workers-ai-agents-durable-objects-tutorial-2026/hero.png)
